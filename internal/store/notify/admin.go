...
func (r *Repo) FetchDeadNotifications(limit int) ([]models.Notification, error) {
...
func (r *Repo) ResetNotification(postID int64, channel string) (bool, error) {
	res, err := r.DB.Exec(`UPDATE notifications SET status='pending', attempts=0, last_error=''
