...
// ByLocationTag 按第一条 location 标签分组；无则未分组
func ByLocationTag(posts []models.RentPost) map[string][]models.RentPost {
...
func SortByPriority(items []port.NotifyItem) []port.NotifyItem {
	sorted := append([]port.NotifyItem(nil), items...)
